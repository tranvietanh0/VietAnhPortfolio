        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <a
              ...
              className="flex items-center gap-2 text-text-secondary hover:text-accent transition-colors text-sm mb-4"
            >
              <Mail size={16} />
              {personalInfo.email}
            </a>
              ...
              {Object.entries(personalInfo.social).map(([platform, url]) => {
                ...
                return Icon ? (
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-dark-tertiary flex items-center justify-center text-text-secondary hover:text-accent hover:bg-accent/10 transition-all duration-300"
                    aria-label={platform}
                  >
                    <Icon size={18} />
                  </a>
